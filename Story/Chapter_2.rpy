...
#image Дима_кпоп1 = "Персонажи/Дима_кпоп1.png"
#image Дима_кпоп2 = "Персонажи/Дима_кпоп2.png"
#image Дима_кпоп3 = "Персонажи/Дима_кпоп3.png"
...
label Chapter_2:
    ...
    "Глава 2: “Обитель желаний“" with dissolve
    ...
    show Дима_уставший at left with dissolve
    ...
    menu:
        ...
        "Look Дахён из Twise":
            ...
            $ k = 2
    if k == 0:
        show Дима_кпоп1 at left
        with dissolve
    if k == 1:
        show Дима_кпоп2 at left
        with dissolve
    if k == 2:
        show Дима_кпоп3 at left
        with dissolve
    Dima "Ну как я вам?"
    ...
    hide Дима_уставший
    show Дима_танцует with dissolve
    ...
    show Вика at left with easeinleft
    Vika "Я Вам до сих пор не верю..."
    hide Вика with easeoutleft
    ...
    show Дима_радостный at left with dissolve
    ...
    show Чим Чин Пак_Кум Чун Пук at right with dissolve
